...
left = ["batman", "wolverine", "ironman", "spiderman", "superman", "thor", "flash", "storm", "superwoman", "hulk",
        "wonderwoman", "catwoman", "tigra", "jade", "captainamerica", "greenlantern", "elektra", "mystique", "xena",
        "blade", "greenarrow", "cyclops", "iceman", "raven", "venus", "robin", "rogue", "ghostrider", "scoobydoo",
        "batwoman", "aquaman", "hawkeye", "colossus", "xman", "zorro", "blackpanther", "magneto", "kinetix", "crystal",
        "blackknight", "firestorm", "halo", "dawn"]
...
right = ["albattani", "almeida", "archimedes", "ardinghelli", "babbage", "bardeen", "bartik", "bell", "blackwell",
         "bohr", "brattain", "brown", "carson", "colden", "curie", "darwin", "davinci", "einstein", "elion",
         "engelbart", "euclid", "fermat", "fermi", "feynman", "franklin", "galileo", "goldstine", "goodall", "hawking",
         "heisenberg", "hoover", "hopper", "hypatia", "jones", "kirch", "kowalevski", "lalande", "leakey", "lovelace",
         "lumiere", "mayer", "mccarthy", "mcclintock", "mclean", "meitner", "mestorf", "morse", "newton", "nobel",
         "pare", "pasteur", "perlman", "pike", "poincare", "ptolemy", "ritchie", "rosalind", "sammet", "shockley",
         "sinoussi", "stallman", "tesla", "thompson", "torvalds", "turing", "wilson", "wozniak", "wright", "yonath"]
